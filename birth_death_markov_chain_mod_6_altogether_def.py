...
res = solve(Pi_by_P_minus_1I,[pi0,pi1,pi2,pi3]) #it returns the eigenvector for the eigenvale of lambda=1
print('\n res = \n', res) # eigenvalues: this is the solution of (A-lambda*I)*x=0, with lambda=1. So it is necessary to normalize by the adding_up_to_1 probabilities)
...
x_normalizado2 = (1/suma_x2) * Matrix([ res[pi0]/pi3 , res[pi1]/pi3 , res[pi2]/pi3, pi3/pi3])#FUNCIONÓ!!!
...
print('\n res2 = \n', res2) #this solution involves the complementary equation where sum_j of pi_j = 1 (no need to normalize by the adding_up_to_1 probabilities)
...
#P_eigenvects = P.eigenvects()  #muy pesado computacionalmente y no se ve la convergencia fácilmente porque en lugar de ser numérico es simbólico
#print("Eigenvects of a matrix : {}".format(P_eigenvects))   

#print('\n P^10 \n=', simplify(P*P*P*P*P*P*P*P*P*P))#muy pesado computacionalmente y no se ve la convergencia fácilmente porque en lugar de ser numérico es simbólico