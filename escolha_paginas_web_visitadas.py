...
P = np.array([[1/2,0,1/2,0,0],[1/5,1/5,1/5,1/5,1/5],[1/3,1/3,0,1/3,0],[0,0,0,0,1],[0,0,1/2,1/2,0]])
Pt = P.copy()
...
Mmod = np.array([[(1/2)-eigenvalue,0,1/2,0,0],[1/5,(1/5)-eigenvalue,1/5,1/5,1/5],[1/3,1/3,0-eigenvalue,1/3,0],[0,0,0,0-eigenvalue,1],[1,1,1,1,1]])#-eigenvalue(-1) in the main diagonal, and last raw is replaced but the constraint (pi0+pi1+pi2+pi3+pi4=1)
print('\n Mmod= \n',Mmod)
...
print(autovectores[:,2])# está en la posición 2 de la lista

suma = sum(autovectores[:,2])# equivalente a autovectores[:,2][0]*5 porque son 5 iguales
print()
print('suma:',suma) # restricción para normalizar ya que la suma de las probabilidades debe ser 1*

probabilidades = (1/suma)*autovectores[:,2] #restricción para normalizar ya que la suma de las probabilidades debe ser 1*
print()
